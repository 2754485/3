...
local UITab14 = win:Tab("『99夜』",'114514')
...
local about = UITab13:section("『挽脚本通用源码☆99夜』", true)
about:Button("99夜", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/atnew2025/Chinese-scripts/refs/heads/main/voidware-cn.txt"))() --未写完
